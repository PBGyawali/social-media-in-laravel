	            			...
	            			<table class="table table-striped table-bordered" id="table">
	            				<thead>
	            					<tr>
										...
										<th class='publish_status'>Published</th>
										<?php if (auth()->user()->is_admin()): ?>
										<?php	echo 	'<th class="anonymous">Anonymous</th>';?>
										<?php endif?>
		          		...
		          		<div class="row">
							<label class="col-md-1 text-left">Publish</label>
								<div class="col-md-1 text-left">
									<input type="checkbox" name="publish_status" id="publish" value="active" class="form-control" >
								</div>
								<?php if(auth()->user()->is_admin()):?>
