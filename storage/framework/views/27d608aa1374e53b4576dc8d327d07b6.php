...
<?php echo $__env->make('admin_sidebar',['size'=>'-10'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
  <div class="card">
	<div class="card-header">
		<?php echo $__env->make('header_card',['element'=>'post','name'=>'management'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
	</div>
	<div class="card-body" id="topic-list-box">
		<div class="table-responsive">
			<?php echo $__env->make('table',['headers'=>['id','title','username'=>'author','created_at','updated_at','post_status'=>'published',
			auth()->user()->is_admin()?"anonymous":'']], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
		</div>
	</div>
</div>
...
<?php /**PATH D:\Dropbox\UniServerZ\www\media\resources\views/admin/posts.blade.php ENDPATH**/ ?>