                        ...
                        <div class="card-box">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-9">
                                            <div class="text-ellipsis m-b-10">
                                                <span class="mail-view-title font-weight-bold h4"><?php echo e($email->subject); ?></span>
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                    ...
                                    <div class="sender-info ">
                                        <div>
                                            <span class="sender-img">
                                                <img width="40" alt="" src="<?php echo e(asset('/images/user_images')); ?>/user_profile.png" class="rounded-circle">
                                            </span>
                                            <span class="receiver-details float-left">
                                                <div class="sender-name"><?php echo e($email->full_name); ?> [<?php echo e($email->email); ?>]</div>
                                        ...
                                        <div class="mail-sent-time">
                                            <span class="mail-time text-right"><?php echo e($email->created_at); ?></span>
                                        </div>
                            ...
                            <div class="mail-attachments">
                                ...
                                <ul class="attachments clearfix text-center row">
                                    ...
                                    <li class="col-2">
                                        <div class="attach-file py-3 w-auto">
                                            <img src="<?php echo e(asset('/images/logo')); ?>/nothumbnail.png"width="80"alt="Attachment">
                                        </div>
                                        <div class="attach-info bg-secondary">
...
<?php echo $__env->make('layouts.footer_script', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Dropbox\UniServerZ\www\media\resources\views/admin/mail-view.blade.php ENDPATH**/ ?>