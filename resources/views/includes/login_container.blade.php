<div class="container"id="login_container">
  ...
  <div class="social">
        ...
        <ul>
          <li>
          <a href="{{ route('social.login', ['provider' => 'facebook']) }}" class="facebook"><span class="fab fa-facebook"></span></a>
          </li>
          <li>
          <a href="{{ route('social.login', ['provider' => 'twitter']) }}" class="twitter"><span class="fab fa-twitter"></span></a>
          </li>
          <li>
            <a href="{{ route('social.login', ['provider' => 'google']) }}" class="google-plus"><span class="fab fa-google-plus"></span></a>
          </li>
        </ul>
       </div>
    <div class="divider">
