	        ...
	        <div class="col-2 collapse show bg-dark">
				...
				<ul class="text-white" >
					...
					<li class="pt-3 nav-item">
						<a href="{{route('support')}}" class="nav-link {{$support_active}}">Inbox <span class="mail-count">({{$total_inbox??''}})</span></a>
					</li>
					<li class="nav-item">
					...
					<li>
						<a class="nav-link inactive_class" href="#">Draft <span class="mail-count">({{$total_draft??8}})</span></a>
					</li>
