<div class="card-body text-center  offset-0 ml-0 p-0">
    ...
    <div class="col-md-12 text-center">
        ...
        <form id="picture_upload" action="<?= route('user.profile.update',$user->id)?>" method="post" enctype="multipart/form-data" style="display:none;">
            <input type="file" name="user_image" id="file_upload" class="mb-2 d-block file_upload" data-allowed_image='[<?= '"'.implode('","', ALLOWED_IMAGES) .'"';?>]' data-upload_time="now" accept="<?= "image/".implode(", image/", ALLOWED_IMAGES);?>"  >
