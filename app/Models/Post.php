...
class Post extends Model
{
    ...
    protected $fillable = ['user_id','title','slug','views','image','body','publish_status','anonymous'];
    ...
    public function scopePublished($query){
        return $query->where('publish_status', '1')->orWhere('publish_status', 'active');
    }
    ...
    function is_published(){
        return $this->publish_status==1 ? true : ($this->publish_status=='active'?true:false);
    }
